...
CUDAQ_TEST(BuilderTester, checkSimple) {
...

  {
    ...
    cudaq::spin_op h = 5.907 - 2.1433 * cudaq::spin_operator::x(0) * cudaq::spin_operator::x(1) - 2.1433 * cudaq::spin_operator::y(0) * cudaq::spin_operator::y(1) +
                       .21829 * cudaq::spin_operator::z(0) - 6.125 * cudaq::spin_operator::z(1);
    cudaq::spin_op h3 = h + 9.625 - 9.625 * cudaq::spin_operator::z(2) - 3.913119 * cudaq::spin_operator::x(1) * cudaq::spin_operator::x(2) -
                        3.913119 * cudaq::spin_operator::y(1) * cudaq::spin_operator::y(2);
